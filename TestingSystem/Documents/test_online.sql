...
CREATE TABLE `newses` (
  ...
  `description` text,
  `content` text,
  `status` tinyint(3) DEFAULT NULL COMMENT '0: pending, 1: approved, 2: reject',
  `is_hot` tinyint(2) DEFAULT NULL COMMENT '0: No, 1: Yes',
  `user_id` int(10) DEFAULT '0',
  `approver_id` int(10) DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
-- Dump completed on 2018-12-03 16:29:31
